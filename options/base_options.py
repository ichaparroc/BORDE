...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--preprocess_mode_label', type=str, default='scale_width_and_crop', help='scaling and cropping of images at load time.', choices=("resize_and_crop", "crop", "scale_width", "scale_width_and_crop", "scale_shortside", "scale_shortside_and_crop", "fixed", "none", "gray"))
        parser.add_argument('--preprocess_mode_image', type=str, default='scale_width_and_crop', help='scaling and cropping of images at load time.', choices=("resize_and_crop", "crop", "scale_width", "scale_width_and_crop", "scale_shortside", "scale_shortside_and_crop", "fixed", "none", "gray", "four"))
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='borde', help='selects model to use for netG (pix2pixhd | spade | borde)')
